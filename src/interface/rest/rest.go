...
import (
	...
	bookHandler "books/src/interface/rest/handlers/books"
	healthHandler "books/src/interface/rest/handlers/health"
	pickupHandler "books/src/interface/rest/handlers/pickup"
	"books/src/interface/rest/response"
	"books/src/interface/rest/route"
...
func makeRoute(
	...
	bh := bookHandler.NewBooksHandler(respClient, useCases.BookUC)
